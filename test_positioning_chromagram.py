...
filename_spectrogram = wd + filename + "_spectrogram.npy"
# spec_data_act = utils.get_spectrogram(filename_wav)
...
spec_data_est = utils.get_wav_spectrogram(filename_wav, start_sec = 48.0, end_sec = 51.0)
